...
$postTitle = $_POST['title'] ?? $post['title'] ?? "";
$postUser = $_POST['user_id'] ?? $post['user_id'] ?? "";
$postContent = $_POST['content'] ?? $post['content'] ?? "";
    ...
    <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <form action="/posts/update" method="POST">
            ...
            <div class="mt-6">
                ...
                <div class="mt-2">
                    <textarea rows="6" name="content" placeholder="Post Content" id="content"
                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"><?= $postContent ?></textarea>
                </div>
            ...
            <div class="mt-6 flex items-center gap-4">
                <a href="/posts"
                    class="block rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
                    Cancel
                </a>
                <button type="submit"
