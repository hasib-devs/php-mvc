        ...
        <ul role="list" class="space-y-3">
            <?php foreach ($posts as $post): ?>
                <li class="flex items-center bg-white overflow-hidden rounded-md shadow-sm">
                    ...
                    <a href="/posts/edit?id=<?= $post['id'] ?>" class="hover:bg-gray-100 rounded-md mx-2 py-2 px-2.5">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit"
                            class="px-2.5 mx-2 py-2 rounded-md hover:bg-red-500 hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
